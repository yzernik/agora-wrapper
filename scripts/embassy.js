...
const setConfig1 = async (effects, input)=>{
    ...
    const depsLnd = newConfig?.wallet?.type === "lnd" ? {
        lnd: []
    } : {};
    const depsCln = newConfig?.wallet?.type === "cln" ? {
        "c-lightning": []
    } : {};
    return await mod3.setConfig(effects, input, {
        ...depsLnd,
        ...depsCln
    });
};
...
const getConfig1 = mod3.getConfig({
    ...
    "wallet": {
        ...
        "tag": {
            ...
            "description": "The LN node to connect to"
        },
        "default": "lnd",
        "variants": {
            "lnd": {},
